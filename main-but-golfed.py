...
root=tk.Tk(); root.title("be quiet"); root.geometry("400x280"); root.resizable(False,False)
s=ttk.Style(); s.theme_use("clam")
mf=ttk.Frame(root, padding=20); mf.pack(expand=True,fill="both")
ttk.Label(mf, text="be quiet", font=("Arial",18)).pack(pady=(0,10))
...
ti=pystray.Icon("sd", mk_ic(), "be quiet", m)
